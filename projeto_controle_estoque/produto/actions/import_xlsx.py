import xlrd
from projeto_controle_estoque.produto.models import Produto, Categoria



def import_xlsx(filename):
	'''
		Importa um arquivo no formato xlsx
	'''
	...
	categorias_unicas = [Categoria(categoria=categoria) for categoria in set(categorias)]
