...
def produto_json(request, pk):
	""" Retorna o id, produto e estoque """
...
def export_csv(request):
	...
	with open('fix/produtos_exportado.csv', 'w') as csvfile:
		produto_write = csv.writer(csvfile)
		produto_write.writerow(header)

		for produto in produtos:
			produto_write.writerow(produto)
